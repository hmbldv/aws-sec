...
```bash
git clone https://gitlab.com/squinky/aws-sec.git
cd aws-sec
```
...
```hcl
aws_account_id      = "266735821834"  # Your AWS account ID
...
```
state_bucket_name   = "terraform-state-266735821834-us-west-1"
dynamodb_table_name = "terraform-state-locks"
...
terraform {
  backend "s3" {
    bucket         = "terraform-state-266735821834-us-west-1"  # From Step 3
...
- GitLab: [squinky](https://gitlab.com/squinky)
